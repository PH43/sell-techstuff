...
<div class="w3layouts-main">
	...
	?>
		...
		{{ csrf_field() }}
            <input type="text" class="ggg" name="admin_name" value="{{old('admin_name')}}" placeholder="Điền Name" required="" >
            <input type="text" class="ggg" name="admin_phone"  value="{{old('admin_phone')}}" placeholder="Điền Phone" required="" >
