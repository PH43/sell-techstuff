    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{('public/backend/images/2021_03_12_08_52_IMG_6037.JPG')}}">
                <span class="username">
			<?php
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{URL::to('/logout-auth')}}"><i class="fa fa-key"></i> đăng xuất</a></li>
            </ul>
        </li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-customer')}}">Thêm Customer</a></li>
						<li><a href="{{URL::to('/customer')}}">Liệt kê Customer</a></li>
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/order')}}">Liệt kê đơn hàng</a></li>
					...
					@impersonate
                        ...
                        <li><a href="{{URL::to('/impersonate_destroy')}}">Dừng chuyển quyền</a></li>
